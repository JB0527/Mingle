...
#os.chdir('/home/qhdrl527/work/workspace/SpeechFeedback/kospeech')
...
async def ipa_feedback(file: UploadFile = File(...)):
    ...
    model_path = "model.pt" # set here model path you want
    audio_path = filename
    device = "cpu"
    
    feature = parse_audio(audio_path, del_silence=True)
    input_length = torch.LongTensor([len(feature)])
    vocab = KsponSpeechVocabulary('/home/qhdrl527/work/workspace/SpeechFeedback/kospeech/bin/aihub_labels.csv')
